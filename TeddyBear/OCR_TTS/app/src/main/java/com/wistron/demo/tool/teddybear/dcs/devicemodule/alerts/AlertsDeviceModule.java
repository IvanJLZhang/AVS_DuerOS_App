...
import com.wistron.demo.tool.teddybear.dcs.devicemodule.alerts.message.AlertPayload;
import com.wistron.demo.tool.teddybear.dcs.devicemodule.alerts.message.AlertsStatePayload;
...
public class AlertsDeviceModule extends BaseDeviceModule implements AlertHandler {
    ...
    private final IAlertDataStore dataStore;
    // 播放闹铃/提醒的mediaPlayer
    ...
    public AlertsDeviceModule(IMediaPlayer mediaPlayer, IAlertDataStore dataStore,
    ...
    @Override
    public void handleDirective(com.wistron.demo.tool.teddybear.dcs.framework.message.Directive directive) throws HandleDirectiveException {
    ...
    private void loadFromDisk() {
        dataStore.readFromDisk(new IAlertDataStore.ReadResultListener() {
    ...
    private synchronized void add(final Alert alert, final boolean suppressEvent) {
        ...
        dataStore.writeToDisk(getAllAlerts(), new IAlertDataStore.WriteResultListener() {
