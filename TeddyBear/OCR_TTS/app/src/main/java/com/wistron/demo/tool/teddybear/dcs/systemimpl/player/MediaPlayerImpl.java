...
public class MediaPlayerImpl implements IMediaPlayer {
    ...
    public MediaPlayerImpl() {
        ...
        // 读取音量和静音的数据
        currentVolume = (float) MediaPlayerPreferenceUtil.get(TeddyBearApplication.getContext(),
                KEY_SP_VOLUME, 0.8f);
        isMute = (boolean) MediaPlayerPreferenceUtil.get(TeddyBearApplication.getContext(),
                KEY_SP_MUTE, false);
        // LinkedList
        ...
        telephonyManager = (TelephonyManager)
                TeddyBearApplication.getContext().getSystemService(Service.TELEPHONY_SERVICE);
    ...
    private IAudioStreamStore.OnStoreListener onStoreListener = new IAudioStreamStore.SimpleOnStoreListener() {
        ...
        public void onComplete(String path) {
            LogUtil.i(TAG, "onStoreListener,path:" + path);
    ...
    private void playAsset(String resName) {
        ...
        try {
            AssetManager am = TeddyBearApplication.getContext().getAssets();
    ...
    public void setVolume(float volume) {
        ...
        //  保存数据
        MediaPlayerPreferenceUtil.put(TeddyBearApplication.getContext(),
