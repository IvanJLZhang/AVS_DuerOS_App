...
/**
 * 1.用途：控制各个DeviceModule的播放策略-基类，主要控制的是{@link com.wistron.demo.tool.teddybear.dcs.devicemodule.alerts.AlertsDeviceModule}
 * and {@link com.wistron.demo.tool.teddybear.dcs.devicemodule.voiceoutput.VoiceOutputDeviceModule}
 * and {@link com.wistron.demo.tool.teddybear.dcs.devicemodule.audioplayer.AudioPlayerDeviceModule}
 * <p>
 * 2.如果你需要实现自己的策略需要复写handlePlay方法，该sample中提供了一种暂停策略，即
 * {@link com.wistron.demo.tool.teddybear.dcs.framework.PauseStrategyMultiChannelMediaPlayer}
 * <p>
