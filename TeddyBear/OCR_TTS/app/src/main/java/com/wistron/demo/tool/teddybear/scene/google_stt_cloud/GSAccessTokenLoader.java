...
/**
 * Retrieves an access token needed to call the Cloud Speech GSapi.
 */
public class GSAccessTokenLoader extends AsyncTaskLoader<AccessToken> {

    private static final String TAG = "GSAccessTokenLoader";

    private static final String PREFS = "GSAccessTokenLoader";
    ...
    public GSAccessTokenLoader(Context context) {
        super(context);
    ...
    public AccessToken getGoogleSTTtoken() {
        final SharedPreferences prefs =
                getContext().getSharedPreferences(PREFS, Context.MODE_PRIVATE);
        String tokenValue = prefs.getString(PREF_ACCESS_TOKEN_VALUE, null);
        long expirationTimeMillis = prefs.getLong(PREF_ACCESS_TOKEN_EXPIRATION_TIME, -1);
