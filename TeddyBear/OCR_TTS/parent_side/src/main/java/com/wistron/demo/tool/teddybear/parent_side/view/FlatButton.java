package com.wistron.demo.tool.teddybear.parent_side.view;
...
public class FlatButton extends Button implements
    ...
    private void init(AttributeSet attrs) {
        ...
        if (attrs != null) {
            ...
            right = a.getDimensionPixelSize(R.styleable.fl_FlatButton_fl_blockButtonRightEffectHeight,
                    right);
...
//		normalBack.setPadding(0, 0, 0, bottom);
        normalBack.setPadding(0, 0, right, bottom);
...
//			pressedBack.setPadding(0, 0, 0, bottom / 2);
            pressedBack.setPadding(0, 0, right / 2, bottom / 2);
